...
public class LC642 {
    ...
    public List<String> input(char c) {
        if (c == '#') {
            ...
            path.setLength(0);
            int count = countMap.getOrDefault(sentence, 0) + 1;
    ...
    public void insert(String word, int count) {
        ...
        for (char ch: word.toCharArray()) {
            int idx = ch - 'a' > 0 ? ch - 'a' : 26;
            if (cur.children[idx] == null) {
                cur.children[idx] = new TrieNode(ch);
            }
            updateTop3(cur.children[idx], word, count);
            cur = cur.children[idx];
        }
        cur.isWord = true;
    }

    public void updateTop3(TrieNode cur, String word, int count) {
        boolean found = false;
        List<Pair> top3 = cur.top3;
        for (Pair pair: top3) {
            if (pair.str.equals(word)) {
                pair.count = count;
                found = true;
            }
        }
        if (!found) {
            top3.add(new Pair(word, count));
        }
        Collections.sort(top3, new Comparator<Pair>() {
        ...
        cur.top3 = top3.subList(0, Math.min(top3.size(), 3));

    }

    public List<String> getTop3(TrieNode cur) {
        List<String> res = new ArrayList<>();
        for (Pair pair: cur.top3) {
            res.add(pair.str);
        }
        return res;
    }
...
//        int[] times = new int[] {12,9,4,4,1,5,3,4,7,9,2,4,2,3,11,13,1,3,4,10,7,1,9,5,10,14,5,3,2,11,5,14,4,13,11,5,15,8,1,12,2,11,4,2,11,14,9,12,1,7,13,11,7,2,6,10};
        ...
        LC642 lc642 = new LC642(sentences, times);

//        System.out.println(lc642.input('w').toString());
//        System.out.println(lc642.input('o').toString());
//        System.out.println(lc642.input('f').toString());
//        System.out.println(lc642.input('q').toString());
//        System.out.println(lc642.input('m').toString());
//        System.out.println(lc642.input('p').toString());
//        System.out.println(lc642.input('k').toString());
//        System.out.println(lc642.input('q').toString());
//        System.out.println(lc642.input('g').toString());
//        System.out.println(lc642.input('i').toString());
//        System.out.println(lc642.input('s').toString());
//        System.out.println(lc642.input('a').toString());
//        System.out.println(lc642.input('v').toString());
//        System.out.println(lc642.input('#').toString());
